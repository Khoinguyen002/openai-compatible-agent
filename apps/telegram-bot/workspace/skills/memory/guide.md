...
**⚠️ READ YOUR TOOL DESCRIPTIONS**: For exact parameters and usage, read the schemas for `memory_write`, `memory_read`, `memory_delete`, and `memory_list` provided in your runtime environment. **Do not hallucinate parameters.**
